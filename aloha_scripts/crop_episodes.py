...
# def crop_dataset(dataset_dir, dataset_name, num_steps):
#     """对数据集进行裁剪，只保留前 num_steps 步"""
...
#         # 裁剪 '/observations/qpos'
#         if '/observations/qpos' in f:
#             qpos = f['/observations/qpos'][()]
#             qpos_crop = qpos[:num_steps]
#             del f['/observations/qpos']
#             f.create_dataset('/observations/qpos', data=qpos_crop)
#         # 裁剪 '/action'
#         if '/action' in f:
#             action = f['/action'][()]
#             action_crop = action[:num_steps]
#             del f['/action']
#             f.create_dataset('/action', data=action_crop)
        
#         print(f"Dataset cropped to the first {num_steps} steps in: {dataset_path}")
...
#             crop_dataset(dataset_dir, dataset_name, 200)
#     else:
